// 明海・高洲線（route-18）の道路形状ポリシーと実行時検証。
...
(() => {
  ...
  const MIN_PATH_POINTS_BY_SYSTEM = {
    "18-takasu-seaside": 277,
    "18-urayasu-eki-iriguchi": 234,
    "18-takasu-kita-shogakko": 215,
    "18-takasu-seaside-from-shinurayasu": 138,
    "18-shinurayasu-from-takasu": 124
  };
  const MAX_GAP_M = 30;
  ...
  window.AKEMI_TAKASU_LINE_PATH_POLICY_V1 = {
    POLICY_VERSION,
