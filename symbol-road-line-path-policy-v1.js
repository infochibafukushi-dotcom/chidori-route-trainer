// シンボルロード線（route-11）の道路形状ポリシーと本番ブラウザ検証。
// 停留所順：京成バスナビ通過時刻表で確認済み。
// 座標・道路：OSM relation 18352884/18352883採用（要走行確認）。
(() => {
  const POLICY_VERSION = '2026-07-25-symbol-road-line-path-v1';
  // floors ≈ actual counts * 0.7
  const MIN_PATH_POINTS_BY_SYSTEM = {
      "11-urayasu-hinode": 226,
      "11-urayasu-sogo-via-hinode-kominkan": 193,
      "11-urayasu-baypark": 170,
      "11-urayasu-shinurayasu": 99,
      "11-shinurayasu-hinode": 128,
      "11-shinurayasu-sogo": 95,
      "11-shinurayasu-baypark": 71,
      "11-hinode-urayasu": 202,
      "11-hinode-shinurayasu": 119,
      "11-sogo-shinurayasu": 77,
      "11-sogo-urayasu": 160
  };
  const MAX_GAP_M = 30;
  ...
  window.SYMBOL_ROAD_LINE_PATH_POLICY_V1 = {
    POLICY_VERSION,
