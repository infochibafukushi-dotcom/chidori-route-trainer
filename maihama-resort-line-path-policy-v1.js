// 舞浜リゾート線（route-12）の道路形状ポリシーと本番ブラウザ検証。
// 停留所順：京成バスナビ通過時刻表で確認済み（ホ=12）。
// 座標・道路：OSM relation 18381677/18381676採用（要走行確認）。
(() => {
  const POLICY_VERSION = '2026-07-25-maihama-resort-line-path-v1';
  const MIN_PATH_POINTS_BY_SYSTEM = {
    "12-maihama-via-resort": 464,
    "12-urayasu-via-resort": 459
  };
  const MAX_GAP_M = 30;
  ...
  window.MAIHAMA_RESORT_LINE_PATH_POLICY_V1 = {
    POLICY_VERSION,
