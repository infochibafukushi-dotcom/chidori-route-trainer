// 千鳥線（系統番号20・route-20）走行シミュレーション／停留所編集モジュール。
// 停留所順：京成バスナビ個別便通過時刻表で確認（evidence/route20-chidori-implementation-2026-07-27/official-stop-orders.json）。
...
(() => {
  ...
  const SYSTEM_RESOLVED_VERSIONS = {
    '20-maihama-clean-center': '2026-07-27-chidori20-maihama-clean-center-v1',
    '20-maihama-chidori-nishi': '2026-07-27-chidori20-maihama-chidori-nishi-v1',
    '20-chidori-loop': '2026-07-27-chidori20-chidori-loop-v1',
    '20-maihama-chidori-garage': '2026-07-27-chidori20-maihama-chidori-garage-v1',
    '20-chidori-garage-maihama': '2026-07-27-chidori20-chidori-garage-maihama-v1',
    '20-clean-center-maihama': '2026-07-27-chidori20-clean-center-maihama-v1',
    '20-clean-center-maihama-via-saijo': '2026-07-27-chidori20-clean-center-maihama-via-saijo-v1',
  };
  ...
  const NAMES_20_MAIHAMA_CLEAN_CENTER = [
    "舞浜駅",
    "オリエンタルランド本社前",
    "運動公園",
    "千鳥車庫",
  ...
  const NAMES_20_MAIHAMA_CHIDORI_NISHI = [
    "舞浜駅",
    "オリエンタルランド本社前",
    "運動公園",
    "千鳥車庫",
  ...
  const NAMES_20_MAIHAMA_CHIDORI_GARAGE = [
    "舞浜駅",
    "オリエンタルランド本社前",
    "運動公園",
    "千鳥車庫",
  ...
  const NAMES_20_CHIDORI_GARAGE_MAIHAMA = [
    "千鳥車庫",
    "車庫裏",
    "千鳥東",
    "千鳥北",
  ...
  const NAMES_20_CLEAN_CENTER_MAIHAMA = [
    "クリーンセンター",
    "千鳥中央",
    "千鳥北",
    "千鳥車庫",
  ...
  const NAMES_20_CLEAN_CENTER_MAIHAMA_VIA_SAIJO = [
    "クリーンセンター",
    "浦安斎場",
    "千鳥西",
    "千鳥中央",
  ...
  const SYSTEM_DEFINITIONS = {
    '20-maihama-clean-center': {
      key: '20-maihama-clean-center', displayCode: DISPLAY_CODE, directionGroup: 'outbound',
      title: 'クリーンセンター行き（舞浜駅発）',
      summary: '舞浜駅 → クリーンセンター',
      relationId: 18351940,
      timetableSymbol: 'ク',
      naviCourse: '0008200296',
      names: NAMES_20_MAIHAMA_CLEAN_CENTER,
    },
    '20-maihama-chidori-nishi': {
      key: '20-maihama-chidori-nishi', displayCode: DISPLAY_CODE, directionGroup: 'branch',
      title: '千鳥西行き（舞浜駅発・浦安斎場経由）',
      summary: '舞浜駅 → 千鳥西',
      relationId: null,
      timetableSymbol: 'に',
      naviCourse: '0008200297',
      names: NAMES_20_MAIHAMA_CHIDORI_NISHI,
    },
    '20-chidori-loop': {
      key: '20-chidori-loop', displayCode: DISPLAY_CODE, directionGroup: 'loop',
      title: '千鳥循環（舞浜駅発着）',
      summary: '舞浜駅 → 舞浜駅',
      relationId: 18323972,
      timetableSymbol: 'さ',
      naviCourse: '0008200299',
      names: NAMES_20_CHIDORI_LOOP,
    },
    '20-maihama-chidori-garage': {
      key: '20-maihama-chidori-garage', displayCode: DISPLAY_CODE, directionGroup: 'outbound',
      title: '千鳥車庫行き（舞浜駅発・千鳥東経由）',
      summary: '舞浜駅 → 千鳥車庫',
      relationId: 13764790,
      timetableSymbol: '無印',
      naviCourse: '0008200294',
      names: NAMES_20_MAIHAMA_CHIDORI_GARAGE,
    },
    '20-chidori-garage-maihama': {
      key: '20-chidori-garage-maihama', displayCode: DISPLAY_CODE, directionGroup: 'inbound',
      title: '舞浜駅行き（千鳥車庫発）',
      summary: '千鳥車庫 → 舞浜駅',
      relationId: 18323971,
      timetableSymbol: '無印',
      naviCourse: '0008200293',
      names: NAMES_20_CHIDORI_GARAGE_MAIHAMA,
    },
    '20-clean-center-maihama': {
      key: '20-clean-center-maihama', displayCode: DISPLAY_CODE, directionGroup: 'inbound',
      title: '舞浜駅行き（クリーンセンター発・千鳥中央経由）',
      summary: 'クリーンセンター → 舞浜駅',
      relationId: 18351939,
      timetableSymbol: '無印',
      naviCourse: '0008200295',
      names: NAMES_20_CLEAN_CENTER_MAIHAMA,
    },
    '20-clean-center-maihama-via-saijo': {
      key: '20-clean-center-maihama-via-saijo', displayCode: DISPLAY_CODE, directionGroup: 'inbound',
      title: '舞浜駅行き（クリーンセンター発・浦安斎場経由）',
      summary: 'クリーンセンター → 舞浜駅',
      relationId: null,
      timetableSymbol: '無印',
      naviCourse: '0008200298',
      names: NAMES_20_CLEAN_CENTER_MAIHAMA_VIA_SAIJO,
    },
  };

  const DEFAULT_SYSTEM_KEY = '20-maihama-clean-center';
  ...
  function pathDataForSystem(systemKey) {
    const bank = window.CHIDORI_LINE_PATH_V1 || {};
  ...
  function migrateStopId(definition, stop, index) {
    ...
    if (!stop.id || /^chidori-20-[\w-]+-\d{2}$/.test(stop.id)) {
      stop.id = newId;
      return true;
    }
    return false;
  ...
  function makeStop(definition, name, index) {
    ...
    return {
      id: `chidori-${definition.key}-${String(index + 1).padStart(2, '0')}`,
      name,
  ...
  function ensureRoute() {
    ...
    const systems = {};
    let changed = route.chidoriLineVersion !== VERSION;
    ...
    route.chidoriLineVersion = VERSION;
  ...
  function pathIntegrityFail(system, definition, reasons) {
    const policy = window.CHIDORI_LINE_PATH_POLICY_V1;
  ...
  async function resolveSystem(key, { force = false, statusCallback = null } = {}) {
    ...
    if (!route || !definition || !system) throw new Error('千鳥線の系統データがありません。');
  ...
  async function resolveAllSystems(force = false, statusCallback = null) {
    const order = ['20-maihama-clean-center', '20-maihama-chidori-nishi', '20-chidori-loop', '20-maihama-chidori-garage', '20-chidori-garage-maihama', '20-clean-center-maihama', '20-clean-center-maihama-via-saijo'];
  ...
  function migrateStopImageBank(route) {
    const bank = route.chidoriLineStopImages;
  ...
  function showStopImage(route, definition, stop, street) {
    ...
    const existing = street.querySelector('.stop-image-display-v25.chidoriLine-stop-image');
    existing?.remove();
    if (!entry?.dataUrl) return false;
    const overlay = document.createElement('div');
    overlay.className = 'stop-image-display-v25 chidoriLine-stop-image';
  ...
  function hideStopImage(street) {
    street?.querySelector('.chidoriLine-stop-image')?.remove();
  }
  ...
  async function drawGuidance(route, definition, system, token) {
    ...
    try {
      ...
      const message = base.includes('千鳥線の走行データを確認できません')
        ? base
        : [
          '千鳥線の走行データを確認できません。',
          `系統：${definition.key}`,
    ...
    const vehicle = new googleApi.maps.Marker({ map, position: center, icon: busIcon(googleApi), zIndex: 1000, title: `千鳥線 ${definition.title}` });
    ...
    const publishDebugState = () => {
      window.CHIDORI_LINE_DRIVE_STATE = {
        ...simulation,
        ...
        try {
          streetViewService.getPanorama(request, (data, status) => {
            try {
              ...
              console.warn('[chidoriLine] panorama update failed', error);
            }
          });
        } catch (error) {
          console.warn('[chidoriLine] getPanorama failed', error);
          applyPovOnly();
        }
        return true;
      }
    ...
    const updateDrivingVisual = (now, force = false) => {
      ...
      if (!point?.position || !Number.isFinite(point.position.lat) || !Number.isFinite(point.position.lng)) {
        ...
        console.error('[chidoriLine] invalid drive position', point, simulation);
        return;
      }
    ...
    const failStart = (reason) => {
      ...
      console.error('[chidoriLine] drive start failed', reason, {
        systemKey: definition.key,
        pathLength: path.length,
        metricsTotal: metrics.total,
    ...
    status.textContent = `千鳥線｜系統${DISPLAY_CODE}｜${definition.title}｜${stops.length}停留所｜道路形状：OSM relation採用（要走行確認）`;
    publishDebugState();
    cleanupGuidance = () => {
      simulation.running = false;
      simulation.paused = false;
      ...
      telop.remove();
      hideStopImage(street);
      if (window.CHIDORI_LINE_DRIVE_STATE?.systemKey === definition.key) {
        window.CHIDORI_LINE_DRIVE_STATE = null;
      }
    };
  }

  routes = function routesChidoriLineLineV1() {
    const route = ensureRoute();
    ...
    try { window.HOKUEI_GUIDANCE_V22?.cleanup?.(); } catch (error) {
      console.warn('[chidoriLine] hokuei cleanup failed', error);
    }
    ...
    shell(`<section class="guidance-page-v26">
      ...
      <div class="split guidance-v22-split">
        <div class="guidance-map-wrap-v22"><div id="routeMap" class="map guidance-map-v22"></div><div class="guidance-version-v22">千鳥線・系統${DISPLAY_CODE}</div></div>
        <div id="street" class="street guidance-street-v22"></div>
      </div>
      <p id="mapStatus" class="status" hidden aria-hidden="true">千鳥線を準備しています…</p>
    </section>`);
    ...
    drawGuidance(route, definition, system, token).catch((error) => {
      ...
      if (node) {
        ...
        node.textContent = message.includes('千鳥線の走行データを確認できません') || message.includes('系統')
          ? message
          : (`系統=${key} | ${message}`);
      }
      console.error('[chidoriLine] drawGuidance failed', definition.key, error);
    });
  };
  ...
  function openRoute20StopEditor(systemKey, stopIndex) {
    closeEditorDialog();
    const route = ensureRoute();
    ...
    const currentImage = route.chidoriLineStopImages?.[bankKey]?.dataUrl || '';
    ...
    dialog.innerHTML = `<section class="stop-edit-dialog" role="dialog" aria-modal="true">
      <div class="stop-edit-header"><div><h2>千鳥線 停留所設定</h2><p>${DISPLAY_CODE}｜${escHtml(definition.title)}・${stopIndex + 1} / ${system.stops.length}</p></div><button type="button" id="closeStopEditor" class="stop-edit-close">×</button></div>
    ...
    const saveCurrent = () => {
      ...
      if (!route.chidoriLineStopImages) route.chidoriLineStopImages = {};
      if (state.removeImage) delete route.chidoriLineStopImages[bankKey];
      else if (state.dataUrl) route.chidoriLineStopImages[bankKey] = { dataUrl: state.dataUrl, updatedAt: new Date().toISOString(), sourceSystem: systemKey, sourceStopId: stop.id };
      route.chidoriLineStopImageUpdatedAt = new Date().toISOString();
      save();
      return true;
    };
    ...
    document.getElementById('previousStopEdit').onclick = () => { if (!saveCurrent()) return; close(); openRoute20StopEditor(systemKey, stopIndex - 1); };
    document.getElementById('nextStopEdit').onclick = () => { if (!saveCurrent()) return; close(); openRoute20StopEditor(systemKey, stopIndex + 1); };
  ...
  function renderChidoriLineStopList() {
    const route = ensureRoute();
    ...
    box.querySelectorAll('[data-uhd-edit]').forEach((button) => { button.onclick = () => openRoute20StopEditor(definition.key, Number(button.dataset.uhdEdit)); });
  }

  function route20StopEditor() {
    ensureRoute();
    editorRouteId = ROUTE_ID;
  ...
  stopEditor = function stopEditorChidoriLineLineV1() {
