const CACHE_NAME = 'chidori-route-map-v26';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './app-icon.svg',
  './styles.css?v=26',
  './hokuei-route.css?v=26',
  './stop-editor-v8.css?v=26',
  './d1-sync.css?v=26',
  './hokuei-authoritative-v12.css?v=26',
  './hokuei-manual-override-v13.css?v=26',
  './hokuei-driving-v14.css?v=26',
  './hokuei-guidance-v22.css?v=26',
  './hokuei-stop-images-v25.css?v=26',
  './data.js?v=26',
  './app.js?v=26',
  './home-navigation-v25.js?v=26',
  './route-map-link.js?v=26',
  './d1-sync.js?v=26',
  './hokuei-authoritative-v12.js?v=26',
