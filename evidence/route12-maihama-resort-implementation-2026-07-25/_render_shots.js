'use strict';
/** z19/z20 evidence screenshots for route-12 舞浜リゾート線 required locations */
const fs = require('fs');
...
const PATH = load('maihama-resort-line-path-v1.js').MAIHAMA_RESORT_LINE_PATH_V1;
const PLAT = load('maihama-resort-line-platforms-v1.js').MAIHAMA_RESORT_LINE_PLATFORMS_V1;
...
const SHOTS = [
  { file: '12-maihama-urayasu-start-z19.png', ...span('12-maihama-via-resort', '浦安駅入口', 'フラワー通り') },
  { file: '12-maihama-cityhall-entry-z19.png', ...span('12-maihama-via-resort', '堀江東', '市役所入口・郵便局前') },
  { file: '12-maihama-juntendo-z19.png', ...span('12-maihama-via-resort', '日生研修センター', '順天堂病院前') },
  { file: '12-maihama-undokoen-branch-z20.png', ...span('12-maihama-via-resort', '舞浜三丁目', '東京ディズニーシー（Ｒ）', { zoom: 20, centerName: '運動公園' }) },
  { file: '12-maihama-tds-entry-z20.png', ...span('12-maihama-via-resort', '運動公園', '東京ディズニーシー（Ｒ）', { zoom: 20 }) },
  { file: '12-maihama-tds-platform-z20.png', ...span('12-maihama-via-resort', '東京ディズニーシー（Ｒ）', '「ベイサイド・ステーション」', { zoom: 20, centerName: '東京ディズニーシー（Ｒ）' }) },
  { file: '12-maihama-tds-exit-z20.png', ...span('12-maihama-via-resort', '東京ディズニーシー（Ｒ）', '「ベイサイド・ステーション」', { zoom: 20, centerName: '「ベイサイド・ステーション」' }) },
  { file: '12-maihama-bayside-z20.png', ...span('12-maihama-via-resort', '東京ディズニーシー（Ｒ）', 'リゾートホテルエリア・サウス', { zoom: 20, centerName: '「ベイサイド・ステーション」' }) },
  { file: '12-maihama-hotel-south-z20.png', ...span('12-maihama-via-resort', '「ベイサイド・ステーション」', 'リゾートホテルエリア・ノース', { zoom: 20, centerName: 'リゾートホテルエリア・サウス' }) },
  { file: '12-maihama-hotel-north-z20.png', ...span('12-maihama-via-resort', 'リゾートホテルエリア・サウス', '舞浜駅', { zoom: 20, centerName: 'リゾートホテルエリア・ノース' }) },
  { file: '12-maihama-maihama-end-z19.png', ...span('12-maihama-via-resort', 'リゾートホテルエリア・ノース', '舞浜駅') },
  { file: '12-urayasu-maihama-start-z19.png', ...span('12-urayasu-via-resort', '舞浜駅', 'リゾートホテルエリア・ノース') },
  { file: '12-urayasu-hotel-north-z20.png', ...span('12-urayasu-via-resort', '舞浜駅', 'リゾートホテルエリア・サウス', { zoom: 20, centerName: 'リゾートホテルエリア・ノース' }) },
  { file: '12-urayasu-hotel-south-z20.png', ...span('12-urayasu-via-resort', 'リゾートホテルエリア・ノース', '「ベイサイド・ステーション」', { zoom: 20, centerName: 'リゾートホテルエリア・サウス' }) },
  { file: '12-urayasu-bayside-z20.png', ...span('12-urayasu-via-resort', 'リゾートホテルエリア・サウス', '東京ディズニーシー（Ｒ）', { zoom: 20, centerName: '「ベイサイド・ステーション」' }) },
  { file: '12-urayasu-tds-platform-z20.png', ...span('12-urayasu-via-resort', '「ベイサイド・ステーション」', '運動公園', { zoom: 20, centerName: '東京ディズニーシー（Ｒ）' }) },
  { file: '12-urayasu-undokoen-z19.png', ...span('12-urayasu-via-resort', '東京ディズニーシー（Ｒ）', '舞浜三丁目', { centerName: '運動公園' }) },
  { file: '12-urayasu-cityhall-z19.png', ...span('12-urayasu-via-resort', 'ＮＴＴ浦安前', '堀江東', { centerName: '市役所入口・郵便局前' }) },
  { file: '12-urayasu-urayasu-end-z19.png', ...span('12-urayasu-via-resort', 'フラワー通り', '浦安駅入口') },
]
...
async function captureUiShots(browser, serverPort) {
  ...
  await pcPage.goto(`http://127.0.0.1:${uiPort}/index.html?nocache=r12ui`, { waitUntil: 'domcontentloaded' });
  ...
  await pcPage.selectOption('#routeSelect', 'route-12');
  await pcPage.waitForTimeout(800);
  await pcPage.screenshot({ path: path.join(OUT, 'ui-pc-route12.png') });
  await pc.close();
  ...
  await spPage.goto(`http://127.0.0.1:${uiPort}/index.html?nocache=r12uisp`, { waitUntil: 'domcontentloaded' });
  ...
  await spPage.selectOption('#routeSelect', 'route-12');
  await spPage.waitForTimeout(800);
  await spPage.screenshot({ path: path.join(OUT, 'ui-sp390-route12.png') });
  await sp.close();
  uiServer.close();
}
...
async function main() {
  ...
  console.log('saved ui-pc-route12.png');
  console.log('saved ui-sp390-route12.png');
  summary.push({ file: 'ui-pc-route12.png', label: 'route-12 PC UI' });
  summary.push({ file: 'ui-sp390-route12.png', label: 'route-12 SP390 UI' });
