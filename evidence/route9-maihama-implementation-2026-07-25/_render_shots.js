'use strict';
/** z19 evidence screenshots for route-9 舞浜線 required locations */
const fs = require('fs');
...
const PATH = load('maihama-line-path-v1.js').MAIHAMA_LINE_PATH_V1;
const PLAT = load('maihama-line-platforms-v1.js').MAIHAMA_LINE_PLATFORMS_V1;
...
const SHOTS = [
  { file: '9-maihama-urayasu-start-z19.png', ...span('9-maihama', '浦安駅入口', 'フラワー通り') },
  { file: '9-maihama-horie6-z19.png', ...span('9-maihama', '南小入口', '堀江六丁目') },
  { file: '9-maihama-fujimi3-z19.png', ...span('9-maihama', '堀江中学校前', '富士見三丁目') },
  { file: '9-maihama-rosetown-pass-z19.png', ...span('9-maihama', '富士見五丁目', '京成ローズタウン') },
  { file: '9-maihama-maihama-entry-z19.png', ...span('9-maihama', '京成ローズタウン', '舞浜駅') },
  { file: '9-maihama-maihama-end-z19.png', ...span('9-maihama', '富士見五丁目', '舞浜駅') },
  { file: '9-rosetown-urayasu-start-z19.png', ...span('9-rosetown', '浦安駅入口', 'フラワー通り') },
  { file: '9-rosetown-entry-z19.png', ...span('9-rosetown', '堀江三丁目', '南小入口') },
  { file: '9-rosetown-end-z19.png', ...span('9-rosetown', '富士見五丁目', '京成ローズタウン') },
  { file: '9-urayasu-maihama-start-z19.png', ...span('9-urayasu', '舞浜駅', '京成ローズタウン') },
  { file: '9-urayasu-rosetown-pass-z19.png', ...span('9-urayasu', '京成ローズタウン', '富士見五丁目') },
  { file: '9-urayasu-horie6-z19.png', ...span('9-urayasu', '堀江六丁目', '南小入口') },
  { file: '9-urayasu-urayasu-end-z19.png', ...span('9-urayasu', 'フラワー通り', '浦安駅入口') },
  { file: '9-tokai-maihama-start-z19.png', ...span('9-tokai', '舞浜駅', '京成ローズタウン') },
  { file: '9-tokai-horie6-branch-z19.png', ...span('9-tokai', '堀江六丁目', '堀江東') },
  { file: '9-tokai-horiehigashi-z19.png', ...span('9-tokai', '堀江東', '東野一丁目') },
  { file: '9-tokai-higashino-z19.png', ...span('9-tokai', '東野一丁目', '東野プール') },
  { file: '9-tokai-end-z19.png', ...span('9-tokai', '東野プール', '東海大浦安高校入口') },
  { file: '9-maihama-tokai-start-z19.png', ...span('9-maihama-tokai', '東海大浦安高校入口', '東野プール') },
  { file: '9-maihama-tokai-horie6-z19.png', ...span('9-maihama-tokai', '堀江東', '堀江六丁目') },
  { file: '9-maihama-tokai-rosetown-z19.png', ...span('9-maihama-tokai', '富士見五丁目', '京成ローズタウン') },
  { file: '9-maihama-tokai-maihama-end-z19.png', ...span('9-maihama-tokai', '京成ローズタウン', '舞浜駅') },
...
async function captureUiShots(browser, serverPort) {
  ...
  await pcPage.goto(`http://127.0.0.1:${uiPort}/index.html?nocache=r9ui`, { waitUntil: 'domcontentloaded' });
  ...
  await pcPage.selectOption('#routeSelect', 'route-9');
  await pcPage.waitForTimeout(800);
  await pcPage.screenshot({ path: path.join(OUT, 'ui-pc-route9.png') });
  await pc.close();
  ...
  await spPage.goto(`http://127.0.0.1:${uiPort}/index.html?nocache=r9uisp`, { waitUntil: 'domcontentloaded' });
  ...
  await spPage.selectOption('#routeSelect', 'route-9');
  await spPage.waitForTimeout(800);
  await spPage.screenshot({ path: path.join(OUT, 'ui-sp390-route9.png') });
  await sp.close();
  uiServer.close();
}
...
async function main() {
  ...
  console.log('saved ui-pc-route9.png');
  console.log('saved ui-sp390-route9.png');
  summary.push({ file: 'ui-pc-route9.png', label: 'route-9 PC UI' });
  summary.push({ file: 'ui-sp390-route9.png', label: 'route-9 SP390 UI' });
