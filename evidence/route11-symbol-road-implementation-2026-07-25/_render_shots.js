'use strict';
/** z19/z20 evidence screenshots for route-11 シンボルロード線 required locations */
const fs = require('fs');
...
const PATH = load('symbol-road-line-path-v1.js').SYMBOL_ROAD_LINE_PATH_V1;
const PLAT = load('symbol-road-line-platforms-v1.js').SYMBOL_ROAD_LINE_PLATFORMS_V1;
...
const SHOTS = [
  { file: '11-urayasu-hinode-start-z19.png', ...span('11-urayasu-hinode', '浦安駅入口', '神明裏') },
  { file: '11-urayasu-shinurayasu-entry-z19.png', ...span('11-urayasu-hinode', '美浜東団地', '新浦安駅') },
  { file: '11-urayasu-hinode-kominkan-z19.png', ...span('11-urayasu-hinode', '海風の街', '日の出公民館') },
  { file: '11-urayasu-symbol-pc-z19.png', ...span('11-urayasu-hinode', '日の出公民館', 'シンボルロード・パークシティ') },
  { file: '11-urayasu-baypark-z19.png', ...span('11-urayasu-hinode', 'ベイモール', 'ベイパーク') },
  { file: '11-urayasu-sogo-z19.png', ...span('11-urayasu-hinode', 'ベイサイドホテルエリア', '総合公園') },
  { file: '11-urayasu-hinode-end-z19.png', ...span('11-urayasu-hinode', '新浦安温泉', '日の出南') },
  { file: '11-shinurayasu-hinode-start-z19.png', ...span('11-shinurayasu-hinode', '新浦安駅', '入船中央エステート') },
  { file: '11-shinurayasu-baypark-end-z19.png', ...span('11-shinurayasu-baypark', 'ベイモール', 'ベイパーク') },
  { file: '11-shinurayasu-sogo-end-z19.png', ...span('11-shinurayasu-sogo', 'ベイサイドホテルエリア', '総合公園') },
  { file: '11-hinode-urayasu-start-z19.png', ...span('11-hinode-urayasu', '日の出南', '新浦安温泉') },
  { file: '11-hinode-sogo-z19.png', ...span('11-hinode-urayasu', '新浦安温泉', '総合公園') },
  { file: '11-hinode-kominkan-z19.png', ...span('11-hinode-urayasu', 'シンボルロード・パークシティ', '日の出公民館') },
  { file: '11-hinode-shinurayasu-z19.png', ...span('11-hinode-shinurayasu', '入船中央エステート', '新浦安駅') },
  { file: '11-sogo-shinurayasu-start-z19.png', ...span('11-sogo-shinurayasu', '総合公園', 'ベイサイドホテルエリア') },
  { file: '11-sogo-urayasu-end-z19.png', ...span('11-sogo-urayasu', '神明裏', '浦安駅入口') },
  { file: '11-urayasu-shinurayasu-end-z19.png', ...span('11-urayasu-shinurayasu', '美浜東団地', '新浦安駅') },
  { file: '11-urayasu-baypark-short-end-z19.png', ...span('11-urayasu-baypark', 'ベイモール', 'ベイパーク') },
  { file: '11-urayasu-sogo-short-end-z19.png', ...span('11-urayasu-sogo-via-hinode-kominkan', 'ベイサイドホテルエリア', '総合公園') },
];
...
async function captureUiShots(browser, serverPort) {
  ...
  await pcPage.goto(`http://127.0.0.1:${uiPort}/index.html?nocache=r11ui`, { waitUntil: 'domcontentloaded' });
  ...
  await pcPage.selectOption('#routeSelect', 'route-11');
  await pcPage.waitForTimeout(800);
  await pcPage.screenshot({ path: path.join(OUT, 'ui-pc-route11.png') });
  await pc.close();
  ...
  await spPage.goto(`http://127.0.0.1:${uiPort}/index.html?nocache=r11uisp`, { waitUntil: 'domcontentloaded' });
  ...
  await spPage.selectOption('#routeSelect', 'route-11');
  await spPage.waitForTimeout(800);
  await spPage.screenshot({ path: path.join(OUT, 'ui-sp390-route11.png') });
  await sp.close();
  uiServer.close();
}
...
async function main() {
  ...
  console.log('saved ui-pc-route11.png');
  console.log('saved ui-sp390-route11.png');
  summary.push({ file: 'ui-pc-route11.png', label: 'route-11 PC UI' });
  summary.push({ file: 'ui-sp390-route11.png', label: 'route-11 SP390 UI' });
