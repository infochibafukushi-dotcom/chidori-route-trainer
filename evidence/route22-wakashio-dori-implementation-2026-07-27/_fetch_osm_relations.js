'use strict';
/**
 * Fetch full OSM relations for 若潮通り線 route 22.
...
const OUT = __dirname;
const IDS = [18396546, 18396547];
const LABELS = {
  18396546: 'route22 千鳥車庫⇒千鳥東⇒新浦安駅',
  18396547: 'route22 新浦安駅⇒千鳥東⇒千鳥車庫',
};
const UA = 'chidori-route-trainer/route22-wakashio-research';
...
async function main() {
  const summary = {
    ...
    route: 'wakashio-dori-route22',
    lineName: '若潮通り線',
    knownPathSourceIds: IDS,
    separationGuard: 'ref=20 (千鳥線) relations are listed but NEVER used for route-22 geometry.',
    relations: [],
  };
  ...
  await new Promise((r) => setTimeout(r, 1500));
  console.log('probe ref=20 relations in bbox (separation guard)');
  summary.refProbe20 = await probeRefRelations('22');
