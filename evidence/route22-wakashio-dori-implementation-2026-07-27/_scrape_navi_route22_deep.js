'use strict';
/**
 * Deep pass: open EVERY 通過時刻表 (/stops?) link on route-22 course timetables.
...
const out = {
  ...
  lineName: '若潮通り線',
  note: 'Exhaustive per-course trip enumeration for route-22. Mixed cells with [20] require legend gate.',
  courses: [],
  timetables: [],
  signatures: {},
  trips: [],
