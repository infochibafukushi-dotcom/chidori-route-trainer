'use strict';
/**
 * Fetch full OSM relations for 浦安東団地線 route 23.
...
const OUT = __dirname;
const IDS = [18419894, 18419895];
const LABELS = {
  18419894: 'route23 総合公園⇒望海の街・新浦安駅⇒舞浜駅',
  18419895: 'route23 舞浜駅⇒新浦安駅・望海の街⇒総合公園',
};
const UA = 'chidori-route-trainer/route23-urayasu-research';
...
async function main() {
  const summary = {
    ...
    route: 'urayasu-higashi-danchi-route23',
    lineName: '浦安東団地線',
    knownPathSourceIds: IDS,
    separationGuard: 'ref=3 (route-3) relations 18417570/18417571/18417579 are listed but NEVER used for route-23 geometry.',
    relations: [],
  };
  ...
  console.log('probe ref=3 relations in bbox');
  summary.refProbe3 = await probeRefRelations('3');
  await new Promise((r) => setTimeout(r, 1500));
  console.log('probe ref=3 relations in bbox (separation guard)');
  summary.refProbe3 = await probeRefRelations('22');
