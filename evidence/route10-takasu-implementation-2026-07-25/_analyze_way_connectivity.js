'use strict';
/**
 * Analyze way-to-way connectivity for OSM relations 18381757 (outbound) and 18381756 (inbound).
...
const r57 = analyzeRelation(18381757, '新浦安駅');
const r56 = analyzeRelation(18381756, 'みなと南');
