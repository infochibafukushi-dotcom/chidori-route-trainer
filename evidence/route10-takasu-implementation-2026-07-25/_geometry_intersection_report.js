'use strict';
/**
 * Geometry / intersection audit for route-10 高洲線 path banks.
...
const PATH_BANK = loadWindow('takasu-line-path-v1.js').TAKASU_LINE_PATH_V1;
...
async function main() {
  ...
  const report = {
    ...
    route: 'route-10',
    lineName: '高洲線',
    pathFiles: ['takasu-line-path-v1.js', '_path_bank.json'],
    systems: {},
    pass: false,
  };
