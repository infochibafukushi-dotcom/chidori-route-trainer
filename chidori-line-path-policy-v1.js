// 千鳥線（route-20）道路形状ポリシー。
(() => {
  const POLICY_VERSION = '2026-07-27-chidori-line-v1-path';
  const MIN_PATH_POINTS_BY_SYSTEM = {
    "20-maihama-clean-center": 130,
    "20-maihama-chidori-nishi": 149,
    "20-chidori-loop": 291,
    "20-maihama-chidori-garage": 138,
    "20-chidori-garage-maihama": 158,
    "20-clean-center-maihama": 133,
    "20-clean-center-maihama-via-saijo": 172
  };
  const MAX_GAP_M = 30;
