// 高洲線（route-10）の道路形状ポリシーと本番ブラウザ検証。
// 停留所順：京成バスナビ通過時刻表で確認済み（み=10）。
// 座標・道路：OSM relation 18381757/18381756採用（要走行確認）。
(() => {
  const POLICY_VERSION = '2026-07-25-takasu-line-path-v1';
  // floors ≈ actual counts * 0.7
  const MIN_PATH_POINTS_BY_SYSTEM = {
    '10-minato-minami': 153,
    '10-shinurayasu': 130,
  };
  const MAX_GAP_M = 30;
  ...
  window.TAKASU_LINE_PATH_POLICY_V1 = {
    POLICY_VERSION,
