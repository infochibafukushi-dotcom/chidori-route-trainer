(() => {
  ...
  const isHokueiRequest = (request) => {
    ...
    if (typeof routeState !== 'undefined' && (routeState?.routeId === 'route-2' || routeState?.routeId === 'route-3' || routeState?.routeId === 'route-4' || routeState?.routeId === 'route-5' || routeState?.routeId === 'route-6' || routeState?.routeId === 'route-9' || routeState?.routeId === 'route-10')) return false;
