// 若潮通り線（route-22）道路形状ポリシー。
(() => {
  const POLICY_VERSION = '2026-07-27-wakashio-dori-line-22-v1-path';
  const MIN_PATH_POINTS_BY_SYSTEM = {
    "22-shinurayasu-chidori-garage": 249,
    "22-chidori-garage-shinurayasu": 244
  };
  const MAX_GAP_M = 30;
